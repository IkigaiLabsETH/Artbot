...
export const TEST_ACTOR_ID = zeroUuid;
export const TEST_ACTOR_NAME = "Test Actor";
export const TEST_ACTOR_ROLE = "Test Role";
export const TEST_ACTOR_SYSTEM_PROMPT = "You are a test actor.";
export const TEST_ACTOR_USER_PROMPT = "This is a test prompt.";
export const TEST_CONVERSATION_ID = zeroUuid;
