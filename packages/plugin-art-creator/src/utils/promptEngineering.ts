...
export function generateNegativePrompt(): string {
  return 'low quality, bad anatomy, worst quality, low resolution, blurry, distorted proportions, disfigured, deformed, amateur, poorly drawn, ugly, text, watermark, signature, extra limbs, missing limbs, cropped image, out of frame, draft';
} 